...
app_path="$build_root/MorningBriefEventKitReader.app"
contents_path="$app_path/Contents"
binary_path="$contents_path/MacOS/morning-brief-eventkit-reader"
...
stage_app="$stage_root/MorningBriefEventKitReader.app"
stage_contents="$stage_app/Contents"
stage_binary="$stage_contents/MacOS/morning-brief-eventkit-reader"
...
if [[ -e "$app_path" ]]; then
  previous_app="$build_root/MorningBriefEventKitReader.previous.app"
